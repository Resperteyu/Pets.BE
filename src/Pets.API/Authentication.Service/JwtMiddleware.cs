...
namespace Pets.API.Authentication.Service
{
    public class JwtMiddleware
  {
    ...
    public async Task Invoke(HttpContext context, PetsDbContext dataContext)
    {
    ...
    private async Task AttachAccountToContext(HttpContext context, PetsDbContext dataContext, string token)
    {
      try
      {
