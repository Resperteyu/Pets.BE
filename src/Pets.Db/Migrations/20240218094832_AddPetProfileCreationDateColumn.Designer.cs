...
namespace Pets.Db.Migrations
{
    ...
    [Migration("20240218094832_AddPetProfileCreationDateColumn")]
    partial class AddPetProfileCreationDateColumn
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Pets.Db.Models.PetProfile", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("date")
                        .HasDefaultValue(new DateTime(2024, 2, 18, 9, 48, 32, 642, DateTimeKind.Utc).AddTicks(6722));
